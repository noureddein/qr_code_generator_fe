			...
			<Modal show={open} size="4xl" onClose={onClose} popup>
				...
				<Modal.Body>
					<div className="flex flex-col gap-2">
						<CardLoader isLoading={isPending}>
							{data && (
								<UpdateForm
									qrCodeType={
...
const CardLoader = ({
	...
	return isLoading ? (
		<div
			role="status"
			className="rounded max-full animate-pulse md:p-6 dark:border-gray-700"
		>
			<div className="flex items-center justify-center h-56 mb-4 bg-gray-300 rounded dark:bg-gray-700">
				<svg
					className="text-gray-200 size-12 dark:text-gray-600"
					aria-hidden="true"
